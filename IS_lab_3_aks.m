...
% Tikslas
% Išmokti savarankiškai suprogramuoti paprasto netiesinio aproksimatoriaus, 
% grįsto Spindulio tipo bazinių funkcijų tinklu, mokymo (parametrų skaičiavimo) algoritmą.
% Užduotys (maks. 8 balai)
%     Sukurkite spindulio tipo bazinių funkcijų (SBF) tinklo parametrams apskaičiuoti skirtą programą. 
%     SBF turi atlikti aproksimatoriaus funkciją. SBF struktūra:
% 
...
%     - kuriamas neuronų tinklas turėtų "modeliuoti/imituoti šios formulės elgesį" naudodamas visiškai kitokią matematinę išraišką nei ši);
...
% 
%     Neural Networks and Learning Machines (3rd Edition), pagrindinei 
%     užduočiai užtenka perceptrono parametrų atnaujinimo algoritmo 54 psl.,
%     papildomai užduočiai 261-267 psl. pateiktos santraukos k-means + RLS/LMS.
